...
def _mod(variable, from_key, from_mandatory_modifiers, from_optional_modifiers, to_key, to_modifiers=nil)
  data = {}
  data['type'] = 'basic'
  data['from'] = _from(from_key, from_mandatory_modifiers, from_optional_modifiers)
  data['to'] = [{'set_variable': {'name': variable, 'value': 1}}]
  data['to_after_key_up'] = [{'set_variable': {'name': variable, 'value': 0}}]
  data['to_if_alone'] = _to([[to_key, to_modifiers]])
  data
end

def mod(variable, from_key, from_mandatory_modifiers, from_optional_modifiers, to_key, to_modifiers=nil)
  JSON.generate(_mod(variable, from_key, from_mandatory_modifiers, from_optional_modifiers, to_key, to_modifiers))
end

def _key(variable, from_key, from_mandatory_modifiers, from_optional_modifiers, to_key, to_modifiers=nil)
  data = {}
  data['type'] = 'basic'
  if variable
    data['conditions'] = [{'type': 'variable_if', 'name': variable, 'value': 1}]
  end
  data['from'] = _from(from_key, from_mandatory_modifiers, from_optional_modifiers)
  data['to'] = _to([[to_key, to_modifiers]])
  data
end

def key(variable, from_key, from_mandatory_modifiers, from_optional_modifiers, to_key, to_modifiers=nil)
  JSON.generate(_key(variable, from_key, from_mandatory_modifiers, from_optional_modifiers, to_key, to_modifiers))
end
